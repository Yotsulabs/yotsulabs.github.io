...
export default function Footer() {
  return (
    <footer className="bg-brand-purple-light/60 border-t-3 border-brand-ink text-brand-ink py-16 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 pb-12 border-b-2 border-slate-300">
          ...
          <div className="md:col-span-5 space-y-4">
            <a
              href="#"
              className="inline-flex items-center gap-2.5 h-10 px-3.5 rounded-xl bg-white border-2 border-brand-ink shadow-neo-purple"
            >
              <Image
          ...
          <div className="md:col-span-3 space-y-3">
            <h4 className="font-heading font-black text-brand-ink text-base uppercase tracking-wider">
              Navigasi Halaman
            </h4>
            <ul className="space-y-2 text-sm font-semibold font-sans">
              {FOOTER_NAV_LINKS.map((link) => (
                <li key={link.href}>
                  <a
                    href={link.href}
                    className="text-slate-700 hover:text-brand-purple transition-colors"
                  >
                    {link.label}
                  </a>
                </li>
              ...
              {FOOTER_SOCIAL_LINKS.map((social) => {
                ...
                return (
                  <Button
                    ...
                    className="w-14 h-14 sm:w-15 sm:h-15 rounded-2xl border-2 border-brand-ink shadow-neo-purple hover:shadow-neo-sm"
                  >
