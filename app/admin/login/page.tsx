...
export default function AdminLoginPage() {
  ...
  return (
    <div className="min-h-screen bg-grid-pattern flex items-center justify-center p-4 sm:p-6 font-sans text-[#13102b] relative overflow-hidden">
      <div className="w-full max-w-md bg-white border-3 border-[#13102b] rounded-3xl p-8 sm:p-10 shadow-[8px_8px_0px_0px_#7b42f5] relative z-10 space-y-6">
        {/* Header Logo & Title */}
        <div className="flex flex-col items-center text-center">
          <h1 className="text-2xl font-heading font-black text-[#13102b] tracking-tight">
            Admin Yotsulabs
          </h1>
          ...
          <div className="space-y-1 relative">
            ...
            <div className="relative">
              <input
                ...
                className="w-full h-11 pl-10 pr-10 bg-white border-2 border-[#13102b] rounded-xl text-sm font-sans font-medium text-[#13102b] placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-[#7b42f5]"
              />
              <TbLock className="w-4 h-4 text-slate-400 absolute left-3.5 top-1/2 -translate-y-1/2 pointer-events-none" />
              <button
                type="button"
                onClick={() => setShowPassword((prev) => !prev)}
                className="absolute right-3.5 top-1/2 -translate-y-1/2 text-slate-500 hover:text-[#13102b] transition-colors cursor-pointer"
        ...
        <div className="text-center border-t-2 border-slate-100 pt-4">
          <Link
            href="/"
            className="text-xs font-bold text-slate-500 hover:text-[#7b42f5] hover:underline transition-colors"
          >
